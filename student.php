...
$item = mysqli_real_escape_string($conn,$_POST['item']);
 ...
 $balance = $fees-$advancefees;
  ...
  $q1 = $conn->query("INSERT INTO student (sname,snumber,joindate,item,contact,about,emailid,Course,balance,fees) VALUES ('$sname','$snumber','$joindate','$item','$contact','$about','$emailid','$Course','$balance','$fees')") ;
 ...
 $id = mysqli_real_escape_string($conn,$_POST['id']);	
   $sql = $conn->query("UPDATE  student  SET  Course  = '$Course', snumber = '$snumber', item = '$item', about  = '$about'  WHERE  id  = '$id'");
			...
			<script type="text/javascript" src="js/validation/jquery.validate.min.js"></script>
               ...
               <div class="panel panel-primary">
						...
						<div class="form-group">
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="Old">Student Number* </label>
								<div class="col-sm-10">
									<input type="text" class="form-control" id="sname" name="snumber" value="<?php echo $snumber;?>"  />
								</div>
							</div>
							<div class="form-group">
						...
						<div class="form-group">
						 ...
						 <div class="form-group">
								<label class="col-sm-2 control-label" for="Old">Item* </label>
								<div class="col-sm-10">
									<select class="form-control" id="item" name="item">
									<option value="">Select Item</option>
                                    <?php
									$sql = "select * from item where delete_status='0' order by item.item asc";
									$q = $conn->query($sql);
									
									while($r = $q->fetch_assoc())
									{
									echo '<option value="'.$r['item'].'"  '.(($item==$r['item'])?'selected="selected"':'').'>'.$r['item'].'</option>';
									}
									?>									
