...
$sql = "select fees,balance,item  from student where id = '$sid'";
$sq = $conn->query($sql);
$sr = $sq->fetch_assoc();
$totalfee = $sr['fees'];
if($sr['balance']>0)
{
$sql = "insert into fees_transaction(stdid,submitdate,item,transcation_remark,paid) values('$sid','$submitdate','$item','$transcation_remark','$paid') ";
$conn->query($sql);
...
function mydatatable()
{
              ...
              $("#subjectresult").html('<table class="table table-striped table-bordered table-hover" id="tSortable22"><thead><tr><th>Name/Contact</th><th>Balance</th><th>Course</th><th>DOJ</th><th>Item</th><th>Action</th></tr></thead><tbody></tbody></table>');
